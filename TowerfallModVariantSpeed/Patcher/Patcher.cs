...
namespace Patcher {
  public class Patcher {
    ...
    private static string modModulePath = Path.GetFullPath("TowerfallModVariantSpeed.dll");
    ...
    public void Patch(string target = "TowerFall.exe") {
      ...
      Console.WriteLine("Writing {0}", target + ".TowerfallModVariantSpeed.exe");
      baseModule.Write(target+ ".TowerfallModVariantSpeed.exe");
